...
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_tcpdump, static int count_mode);
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_tcpdump, static int dflag);
...
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_tcpdump, static int timeout);
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_tcpdump, static int64_t Cflag);
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_tcpdump, static pcap_dumper_t *pdd);
