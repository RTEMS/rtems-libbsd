...
/* Line 371 of yacc.c  */
#line 51 "freebsd/lib/libipsec/policy_parse.y"
...
{
       0,   116,   116,   115,   124,   134,   136,   148,   149,   150,
     151,   152,   153,   154,   158,   165,   169,   173,   177,   184,
     184,   195,   201
};
#endif
...
#line 184 "freebsd/lib/libipsec/policy_parse.y"
    {
			p_src = parse_sockaddr(&(yyvsp[(1) - (1)].val));
			if (p_src == NULL)
				return -1;
		}
    break;
...
#line 190 "freebsd/lib/libipsec/policy_parse.y"
    {
			p_dst = parse_sockaddr(&(yyvsp[(4) - (4)].val));
			if (p_dst == NULL)
				return -1;
		}
    break;
