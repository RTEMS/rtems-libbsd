...
#line 54 "../../freebsd/lib/libipsec/policy_parse.y"
#ifdef __rtems__
...
#define YYSTYPE_IS_DECLARED 1
#line 100 "../../freebsd/lib/libipsec/policy_parse.y"
typedef union {
        u_int num;
        struct _val {
                int len;
...
#line 215 "../../freebsd/lib/libipsec/policy_parse.y"
...
yyreduce:
    ...
    {
case 1:
#line 118 "../../freebsd/lib/libipsec/policy_parse.y"
        {
...
#line 811 "__libipsecyy.tab.c"
break;
case 3:
#line 127 "../../freebsd/lib/libipsec/policy_parse.y"
        {
...
#line 822 "__libipsecyy.tab.c"
break;
case 5:
#line 138 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        if (rule_check() < 0)
                                return -1;
...
#line 835 "__libipsecyy.tab.c"
break;
case 12:
#line 156 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        __ipsec_errcode = EIPSEC_FEW_ARGUMENTS;
                        return -1;
                }
#line 843 "__libipsecyy.tab.c"
break;
case 13:
#line 160 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        __ipsec_errcode = EIPSEC_FEW_ARGUMENTS;
                        return -1;
                }
#line 851 "__libipsecyy.tab.c"
break;
case 14:
#line 167 "../../freebsd/lib/libipsec/policy_parse.y"
        { p_protocol = yystack.l_mark[0].num; }
#line 856 "__libipsecyy.tab.c"
break;
case 15:
#line 171 "../../freebsd/lib/libipsec/policy_parse.y"
        { p_mode = yystack.l_mark[0].num; }
#line 861 "__libipsecyy.tab.c"
break;
case 16:
#line 175 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        p_level = yystack.l_mark[0].num;
                        p_reqid = 0;
                }
#line 869 "__libipsecyy.tab.c"
break;
case 17:
#line 179 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        p_level = IPSEC_LEVEL_UNIQUE;
                        p_reqid = atol(yystack.l_mark[0].val.buf);      /* atol() is good. */
                }
#line 877 "__libipsecyy.tab.c"
break;
case 18:
#line 186 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        p_src = parse_sockaddr(&yystack.l_mark[0].val);
                        if (p_src == NULL)
                                return -1;
                }
#line 886 "__libipsecyy.tab.c"
break;
case 19:
#line 192 "../../freebsd/lib/libipsec/policy_parse.y"
        {
                        p_dst = parse_sockaddr(&yystack.l_mark[0].val);
                        if (p_dst == NULL)
                                return -1;
                }
#line 895 "__libipsecyy.tab.c"
break;
case 20:
#line 197 "../../freebsd/lib/libipsec/policy_parse.y"
        {
...
#line 905 "__libipsecyy.tab.c"
break;
case 21:
#line 203 "../../freebsd/lib/libipsec/policy_parse.y"
        {
...
#line 915 "__libipsecyy.tab.c"
break;
#line 917 "__libipsecyy.tab.c"
    }
    yystack.s_mark -= yym;
