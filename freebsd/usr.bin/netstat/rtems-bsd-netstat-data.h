...
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_netstat, extern int Cflag);
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_netstat, extern int Lflag);
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_netstat, extern int Oflag);
...
/* pfkey.c */
/* route.c */
RTEMS_LINKER_RWSET_CONTENT(bsd_prog_netstat, extern struct _wid wid);
/* route_netlink.c */
/* sctp.c */
/* unix.c */
